...
def create_data_lists(label_map, path, output_folder):
...
def calculate_mAP(label_map, rev_label_map, device, det_boxes, det_labels, det_scores, true_boxes, true_labels, true_difficulties):
...
def transform_data(image, boxes, labels, difficulties, split):
